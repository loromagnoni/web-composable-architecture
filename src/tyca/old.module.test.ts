...
//   const messageModule = messageCreator.composable();
//   const composedModule = defineModule(() => ({
//     initialState: () => ({
//       firstCounter: firstCounter.initialState(),
//       secondCounter: secondCounter.initialState(),
//       message: messageModule.initialState(),
//     }),
//     reducer: {
//       resetCounters: (state) => {
//         state.firstCounter.count = 0;
//         state.secondCounter.count = 0;
//       },
//     },
//     compose: {
//       firstCounter: {
...
//           .composable({ amountProvider })
//           .initialState(),
//         secondCounter: counterCreator
//           .composable({ amountProvider: oddAmountProvider })
//           .initialState(),
//       }),
//       compose: {
//         firstCounter: {
//           selector: (state) => state.firstCounter,
//           reducer: counterCreator.composable({ amountProvider }).reducer,
//         },
//         secondCounter: {
//           selector: (state) => state.secondCounter,
//           reducer: counterCreator.composable({
//             amountProvider: oddAmountProvider,
//           }).reducer,
//         },
//       },
//     })
